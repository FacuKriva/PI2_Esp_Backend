...
public class AccountController {
    ...
    public ResponseEntity<?> getTransactionsWithFilters(@PathVariable("id") Long id, @RequestParam(value = "startDate", required = false) String startDate, @RequestParam(value ="endDate", required = false) String endDate, @RequestParam(value ="rangeSelect", required = false) Integer amount, @RequestParam(value ="type", required = false) String type, @RequestHeader("Authorization") String token) throws Exception{
        return ResponseEntity.status(HttpStatus.OK).body(accountService.getTransactionsWithFilters(id, startDate, endDate, amount, type, token));
