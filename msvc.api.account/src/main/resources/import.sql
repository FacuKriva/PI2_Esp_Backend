...
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, is_enabled, account_id) VALUES (null, 'Amex Platinum', 376455323736878, 'Admin Admin', '03/2025', 1698, 'American Express', 'Crédito', true, 1);
...
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, is_enabled, account_id) VALUES (null, 'Ualá', 5304690884036864, 'User Two', '10/2028', 123, 'Mastercard Argentina', 'Pre-Paga', true, 3);
