...
-- Insert Card
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, card_network, card_Balance, is_enabled, account_id) VALUES (null, 'Tarjeta MP', 5412873403403000, 'Admin Admin', '05/2024', 480, 'Mercado Pago', 'Crédito', "Mastercard", 158000.00, true, 1);
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, card_network, card_Balance, is_enabled, account_id) VALUES (null, 'Tarjeta Amex Platinum', 376455323736878, 'Admin Admin', '03/2025', 1698, 'AMEX', 'Crédito', "AMEX", 275000.00, true, 1);
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, card_network, card_Balance, is_enabled, account_id) VALUES (null, 'Tarjeta Brubank', 4539793783086269, 'User One', '09/2023', 123, 'Brubank S.A.U.', 'Débito', "Visa", 27500.00, true, 2);
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, card_network, card_Balance, is_enabled, account_id) VALUES (null, 'Tarjeta ICBC', 4539270908211569, 'User One', '01/2022', 123, 'ICBC', 'Débito', "Visa", 130000.00, true, 2);
INSERT INTO cards (card_id, alias, card_number, card_holder, expiration_date, cvv, bank, card_type, card_network, card_Balance, is_enabled, account_id) VALUES (null, 'Tarjeta Ualá', 5304690884036864, 'User Two', '10/2028', 123, 'Ualá', 'Pre-Paga', "Mastercard", 0.00, true, 3);
